...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-white">Edit Router</h1>
    <p class="text-gray-400 mt-1">Update router information</p>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="nama_router" id="nama_router" 
                       value="{{ old('nama_router', $router->nama_router) }}" required
            ...
            <div>
                ...
                <input type="number" name="port" id="port" 
                       value="{{ old('port', $router->port) }}" required
                ...
                <select name="router_category_id" id="router_category_id" required
                    ...
                    @foreach($categories as $category)
                        <option value="{{ $category->id }}" 
                                {{ old('router_category_id', $router->router_category_id) == $category->id ? 'selected' : '' }}>
